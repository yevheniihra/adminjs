...
const translations = {
  ...
  messages: {
    ...
    loginWelcome: 'a Adminjs – il principale pannello di amministrazione open-source per la tua applicazione Node.js che ti consente di gestire tutti i tuoi dati in un unico luogo',
