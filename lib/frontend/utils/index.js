...
var _dataCssName = require("./data-css-name");
Object.keys(_dataCssName).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _dataCssName[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _dataCssName[key];
    }
  });
});