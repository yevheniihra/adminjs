...
class ViewHelpers {
  ...
  assetPath(asset, assetsConfig) {
    if (this.options.assetsCDN) {
      ...
      const pathname = (assetsConfig === null || assetsConfig === void 0 || (_assetsConfig$coreScr = assetsConfig.coreScripts) === null || _assetsConfig$coreScr === void 0 ? void 0 : _assetsConfig$coreScr[asset]) ?? asset;
